...
COM HERE IS A PROGRAM
COM IT TESTS MANY THINGS
START
   VAR APPLE = 32
   VAR PEN = APPLE ++
   PRINT APPLE
* Output: APPLE IS 33
   PRINT PEN
* Output: PEN IS 32
   COM HERE IS A NESTED BLOCK
   COM IT DOES MANY THINGS
   START
      VAR PINE = 12
      VAR PINEAPPLE = APPLE + PINE
      PRINT PINEAPPLE
* Output: PINEAPPLE IS 45
      PRINT ++ PINEAPPLE
* Output: ++ PINEAPPLE IS 46
      PRINT 5 * 10
* Output: 5 * 10 IS 50
      PRINT 12 % 10
* Output: 12 % 10 IS 2
      PRINT PINEAPPLE - 10
* Output: PINEAPPLE - 10 IS 36
   FINISH
   PRINT PINEAPPLE
* Output: PINEAPPLE IS UNDEFINED
   PRINT APPLE
* Output: APPLE IS 33
   PRINT APPLE + 54
* Output: APPLE + 54 IS 87
   PEN --
   PRINT PEN
* Output: PEN IS 31
FINISH
